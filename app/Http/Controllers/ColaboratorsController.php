...
class ColaboratorsController extends Controller
{
    ...
    {
        Auth::user()->can('admin', 'rh') ?: abort(403, 'Não está autorizado para entrar nessa página');
    ...
    public function deleteColaborator($id)
    {
        ...
        return view('colaborators.delete-colaborators-confirm', compact('colaborator'));
    }
    ...
    {
        Auth::user()->can('colaborator') ?: abort(403, 'Não está autorizado para entrar nessa página');
