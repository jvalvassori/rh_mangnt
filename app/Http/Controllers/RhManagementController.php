...
class RhManagementController extends Controller
{
    ...
    {
      Auth::user()->can('rh') ?: abort(403, 'Não está autorizado para entrar nessa página');
        ...
        return redirect()->route('rh.management.home')->with('success', 'Colaborator created com successfully');   
    }
